...
"void main()\n"
"{\n"
"    color = vec4(xx.x/10, xx.y/10, xx.z/10, 1.0); \n"
"}\n";
...
int main(int argc, char** argv)
{
    ...
    window = glfwCreateWindow(1920, 1080, "GLFW OpenGL3 Heightmap demo", NULL, NULL);
    if (! window )
    {
        glfwTerminate();
        exit(EXIT_FAILURE);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glDrawElements(GL_TRIANGLE_STRIP, 2* MAP_NUM_LINES , GL_UNSIGNED_INT, 0);
